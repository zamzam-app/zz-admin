...
export type CakeCategoriesModalProps = {
  open: boolean;
  onClose: () => void;
};

export function CakeCategoriesModal({ open, onClose }: CakeCategoriesModalProps) {
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      queryClient.invalidateQueries({ queryKey: CATEGORY_KEYS });
    } catch (err) {
